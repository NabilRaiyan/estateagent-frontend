...
const services = [
  {
    ...
    description: "Find your perfect home from thousands of listings tailored to your needs.",
  ...
  },
  {
    ...
    description: "List your property with us and reach millions of potential buyers quickly.",
  ...
  },
  {
    ...
    description: "Browse available rental homes and apartments in your desired locations.",
  ...
  },
  {
    ...
    description: "Get expert advice and competitive rates to finance your dream property.",
  ...
  return (
    <section className="max-w-6xl mx-auto px-6 py-16">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10">
        {services.map(({ title, imageSrc, description, ctaText, link }) => (
            <ServiceCard
            key={title}
            title={title}
            imageSrc={imageSrc}
